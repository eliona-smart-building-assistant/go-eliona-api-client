...
For more information, please visit [https://new.abb.com/low-voltage/products/building-automation/product-range/abb-ability-buildingpro/buildingpro-suites](https://new.abb.com/low-voltage/products/building-automation/product-range/abb-ability-buildingpro/buildingpro-suites)
...
```go
import api "github.com/eliona-smart-building-assistant/go-eliona-api-client/v3"
```
...
*AlarmsAPI* | [**DeleteAlarmById**](docs/AlarmsAPI.md#deletealarmbyid) | **Delete** /alarms/{alarm-rule-id} | Removes an alarm
...
*AssetTypesAPI* | [**GetAssetTypeCategories**](docs/AssetTypesAPI.md#getassettypecategories) | **Get** /asset-type-categories | List of asset type categories
...
*AssetTypesAPI* | [**PutAssetTypeCategory**](docs/AssetTypesAPI.md#putassettypecategory) | **Put** /asset-type-categories | Create or update an asset type categories
...
*BuildingProSuitesAPI* | [**DeleteTenant**](docs/BuildingProSuitesAPI.md#deletetenant) | **Delete** /tenants | Delete the current tenant
*BuildingProSuitesAPI* | [**GetApiKeys**](docs/BuildingProSuitesAPI.md#getapikeys) | **Get** /api-keys | Information about API keys
*BuildingProSuitesAPI* | [**PutTenant**](docs/BuildingProSuitesAPI.md#puttenant) | **Put** /tenants | Setup or update a tenant
*CalculationRulesAPI* | [**DeleteCalculationRuleById**](docs/CalculationRulesAPI.md#deletecalculationrulebyid) | **Delete** /calculation-rules/{calculation-rule-id} | Delete a calculation rule
*CalculationRulesAPI* | [**GetCalculationRuleById**](docs/CalculationRulesAPI.md#getcalculationrulebyid) | **Get** /calculation-rules/{calculation-rule-id} | Information about a calculation rules rule
*CalculationRulesAPI* | [**GetCalculationRules**](docs/CalculationRulesAPI.md#getcalculationrules) | **Get** /calculation-rules | Information about calculation rules
*CalculationRulesAPI* | [**PutCalculationRule**](docs/CalculationRulesAPI.md#putcalculationrule) | **Put** /calculation-rules | Creates or updates a calculation rule
*CalculationRulesAPI* | [**PutCalculationRuleById**](docs/CalculationRulesAPI.md#putcalculationrulebyid) | **Put** /calculation-rules/{calculation-rule-id} | Update a calculation rule
...
*DataAPI* | [**GetDataTrendAggregatedById**](docs/DataAPI.md#getdatatrendaggregatedbyid) | **Get** /data-trend-aggregated/{asset-id} | Get aggregated trend of historical data
*DataAPI* | [**GetDataTrendById**](docs/DataAPI.md#getdatatrendbyid) | **Get** /data-trend/{asset-id} | Get trend of historical data
...
*DataAPI* | [**PutBulkDataTrend**](docs/DataAPI.md#putbulkdatatrend) | **Put** /data-trend-bulk | Create or update multiple historical data
*DataAPI* | [**PutData**](docs/DataAPI.md#putdata) | **Put** /data | Create or update asset data
*DataAPI* | [**PutDataTrend**](docs/DataAPI.md#putdatatrend) | **Put** /data-trend | Create or update historical data
...
*ProjectsAPI* | [**PutProjectRole**](docs/ProjectsAPI.md#putprojectrole) | **Put** /project-roles | Create or update a project role
*QRCodesAPI* | [**GetQrCodeByAssetId**](docs/QRCodesAPI.md#getqrcodebyassetid) | **Get** /qr-codes/assets/{asset-id} | QR code for assets
*SitesAPI* | [**DeleteSiteById**](docs/SitesAPI.md#deletesitebyid) | **Delete** /sites/{site-id} | Delete a site
*SitesAPI* | [**GetSiteById**](docs/SitesAPI.md#getsitebyid) | **Get** /sites/{site-id} | Information about a site
*SitesAPI* | [**GetSites**](docs/SitesAPI.md#getsites) | **Get** /sites | Information about sites
*SitesAPI* | [**PutSite**](docs/SitesAPI.md#putsite) | **Put** /sites | Create or update a site
...
*UsersAPI* | [**DeleteRoleByName**](docs/UsersAPI.md#deleterolebyname) | **Delete** /roles/{role-name} | Delete a user role
*UsersAPI* | [**DeleteUserById**](docs/UsersAPI.md#deleteuserbyid) | **Delete** /users/{user-id} | Delete a user
*UsersAPI* | [**GetRoleByName**](docs/UsersAPI.md#getrolebyname) | **Get** /roles/{role-name} | Information about a user role
*UsersAPI* | [**GetRoles**](docs/UsersAPI.md#getroles) | **Get** /roles | Information about user roles
*UsersAPI* | [**GetUserById**](docs/UsersAPI.md#getuserbyid) | **Get** /users/{user-id} | Information about a user
*UsersAPI* | [**GetUsers**](docs/UsersAPI.md#getusers) | **Get** /users | Information about users
*UsersAPI* | [**PutRole**](docs/UsersAPI.md#putrole) | **Put** /roles | Create or update a user role
...
## Documentation For Models
 ...
 - [AssetTypeCategory](docs/AssetTypeCategory.md)
 - [AssetTypeCategoryProperty](docs/AssetTypeCategoryProperty.md)
...
Note, each API key must be added to a map of `map[string]APIKey` where the key is: HttpSig and passed in as the auth context for each request.
